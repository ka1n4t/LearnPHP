<?php /* Smarty version Smarty-3.1.6, created on 2018-06-03 22:51:43
         compiled from "H:/PHPStudy/PHPTutorial/WWW/LAB/LearnTHINKPHP/shop/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:32145aeffa242bffd2-88777285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd03959201767b74fb7d4e82626ed953c6c663a33' => 
    array (
      0 => 'H:/PHPStudy/PHPTutorial/WWW/LAB/LearnTHINKPHP/shop/Home/View\\User\\register.html',
      1 => 1528037500,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32145aeffa242bffd2-88777285',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5aeffa244f22b',
  'variables' => 
  array (
    'errorInfo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5aeffa244f22b')) {function content_5aeffa244f22b($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="<?php echo @__ACTION__;?>
" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="password" id="User_password" type="password" />                  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['email'])===null||$tmp==='' ? '' : $tmp);?>
</span>    
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="phone" id="User_user_tel" type="text" value="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <input id="ytUser_user_sex" type="hidden" value="" name="sex" /> -->
                                            <span id="User_user_sex">
                                            <input id="User_user_sex_0" value="1" type="radio" name="sex" /> 
                                            <label for="User_user_sex_0">男</label>&nbsp;
                                            <input id="User_user_sex_1" value="2" type="radio" name="sex" /> 
                                            <label for="User_user_sex_1">女</label>&nbsp;
                                            <input id="User_user_sex_2" value="3" type="radio" name="sex" /> 
                                    ...
                                    <tr> -->
                                        ...
                                        <td>
                                            <!-- <input id="ytUser_user_hobby" type="hidden" value="" name="favourite" /> -->
                                            <span id="User_user_hobby">
                                            <input id="User_user_hobby_0" value="1" type="checkbox" name="favourite[]" /> 
                                            <label for="User_user_hobby_0">篮球</label>&nbsp;
                                            <input id="User_user_hobby_1" value="2" type="checkbox" name="favourite[]" /> 
                                            <label for="User_user_hobby_1">足球</label>&nbsp;
                                            <input id="User_user_hobby_2" value="3" type="checkbox" name="favourite[]" /> 
                                            <label for="User_user_hobby_2">排球</label>&nbsp;
                                            <input id="User_user_hobby_3" value="4" type="checkbox" name="favourite[]" /> 
                                            <label for="User_user_hobby_3">棒球</label>                  
                                            <span style="color:red;"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['favourite'])===null||$tmp==='' ? '' : $tmp);?>
</span>
                                            </span>                                
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea cols="50" rows="5" name="introduce" id="User_user_introduce"></textarea>                      
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
